...
@section('content')
    <div class="mx-auto mt-10 mb-10 text-[#495E57]">
        <h2 class="text-5xl font-extrabold mt-6 mb-8">Halo, Selamat datang {{ Auth::user()->name }}</h2>
        <div class="grid grid-cols-4 grid-rows-3 gap-8 mt-4 mx-auto mb-12">
        ...
        <div class="rounded-lg opacity-8 border-neutral-400/50 drop-shadow-md grid">
            <div class="flex flex-row overflow-x-auto mb-3">
                <div class="flex-shrink-0">
                    <div class="flex flex-row gap-2">
                        @php
...
{{-- <div class="max-w-full px-4 mx-auto overflow-hidden  text-[#495E57]">
