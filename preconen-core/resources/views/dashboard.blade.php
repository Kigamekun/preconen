...
@section('content')
    ...
    <div class="xl:container px-4 mx-auto">
        <h2 class="text-4xl font-extrabold my-3">Halo, Selamat datang Lorem</h2>
        ...
        <h2 class="text-4xl font-extrabold my-3">Lahan Anda</h2>
        ...
        <h2 class="text-4xl font-extrabold my-3">Prakiraan Cuaca</h2>
        <div class="flex flex-row overflow-x-auto">
            <div class="flex-shrink-0">
                <div class="flex flex-row gap-2">
